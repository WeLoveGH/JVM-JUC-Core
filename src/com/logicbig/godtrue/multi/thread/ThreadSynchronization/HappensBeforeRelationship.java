 ...
 * @create：2019-10-25
 */
public class HappensBeforeRelationship {

    /**
     * the wrong code
     */
/*    public synchronized HappensBeforeRelationship() {
    }

    private static final volatile String shardData;*/
...
Volatile variable rule:
   ...
   Writes and reads of volatile fields have similar memory consistency effects as entering and exiting monitors (synchronized block around reads and writes),
...
Thread start rule:
   ...
   All actions performed in thread B's run method will see thread A's calling threadA.start() method and before that (only in thread A) happened before them.
