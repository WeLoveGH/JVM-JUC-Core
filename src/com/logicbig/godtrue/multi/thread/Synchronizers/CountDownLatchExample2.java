...
public class CountDownLatchExample2 {
    ...
    public static void main(String[] args) {
        ...
        ProgressThread progressThread1 = new ProgressThread(latch, 1*10);
        frame.add(progressThread1.getProgressComponent());
        progressThread1.start();

        ProgressThread progressThread2 = new ProgressThread(latch, 2*10);
        frame.add(progressThread2.getProgressComponent());
        progressThread2.start();

        ProgressThread progressThread3 = new ProgressThread(latch, 3*10);
        frame.add(progressThread3.getProgressComponent());
        progressThread3.start();

        ProgressThread progressThread4 = new ProgressThread(latch, 4*10);
        frame.add(progressThread4.getProgressComponent());
...
class ProgressThread2 extends Thread {
    ...
    public ProgressThread2(CountDownLatch latch, int slowness) {
        this.latch = latch;
